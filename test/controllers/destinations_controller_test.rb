...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post destinations_url, params: { destination: { destination: @destination.destination, distance: @destination.distance, origin: @destination.origin } }, as: :json
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { destination: @destination.destination, distance: @destination.distance, origin: @destination.origin } }, as: :json
    assert_response 200
  end
